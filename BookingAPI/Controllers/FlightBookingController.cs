...
namespace TGBookingAPI.Controllers
{
    public class FlightBookingController : ApiController
    {
        ...
        public FlightBookingController(IFlightSearchServices flightSearchServices, INamingServices namingServices, IAPIConfigServices apiConfigServices, ISiteConfigServices siteConfigServices)
        {
