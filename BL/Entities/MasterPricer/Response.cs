...
namespace BL.Entities.MasterPricer
{
    ...
    {
        [JsonProperty("Fare_MasterPricerTravelBoardSearchReply")]
    ...
    public partial class FareMasterPricerTravelBoardSearchReply
    {
        ...
        public ServiceFeesGrpUnion ServiceFeesGrp { get; set; }
    ...
    public partial struct ServiceFeesGrpUnion
    {
        public List<ServiceFeesGrp> ServiceFeesGrpElementArray;
        public ServiceFeesGrp PurpleServiceFeesGrp;
    }
    public partial struct ServiceFeesGrpUnion
    {
        public ServiceFeesGrpUnion(JsonReader reader, JsonSerializer serializer)
        {
            ServiceFeesGrpElementArray = null;
            PurpleServiceFeesGrp = null;

            switch (reader.TokenType)
            {
                case JsonToken.StartArray:
                    ServiceFeesGrpElementArray = serializer.Deserialize<List<ServiceFeesGrp>>(reader);
                    return;
                case JsonToken.StartObject:
                    PurpleServiceFeesGrp = serializer.Deserialize<ServiceFeesGrp>(reader);
                    return;
            }
            throw new Exception("Cannot convert ServiceFeesGrpUnion");
        }

        public void WriteJson(JsonWriter writer, JsonSerializer serializer)
        {
            if (ServiceFeesGrpElementArray != null)
            {
                serializer.Serialize(writer, ServiceFeesGrpElementArray);
                return;
            }
            if (PurpleServiceFeesGrp != null)
            {
                serializer.Serialize(writer, PurpleServiceFeesGrp);
                return;
            }
            throw new Exception("Union must not be null");
        }
    ...
    public partial class Recommendation
    {
        ...
        public FareFamilyRef FareFamilyRef { get; set; }
    }
    public partial class FareFamilyRef
    {
    ...
    public partial class GroupOfFareProductInformation
    {
        ...
        public CabinProductUnion CabinProduct { get; set; }
    ...
    public partial struct CabinProductUnion
    {
        public List<CabinProduct> CabinProductElementArray;
        public CabinProduct PurpleCabinProduct;
    }


    public partial struct CabinProductUnion
    {
        public CabinProductUnion(JsonReader reader, JsonSerializer serializer)
        {
            CabinProductElementArray = null;
            PurpleCabinProduct = null;

            switch (reader.TokenType)
            {
                case JsonToken.StartArray:
                    CabinProductElementArray = serializer.Deserialize<List<CabinProduct>>(reader);
                    return;
                case JsonToken.StartObject:
                    PurpleCabinProduct = serializer.Deserialize<CabinProduct>(reader);
                    return;
            }
            throw new Exception("Cannot convert FareDetailUnion");
        }
        ...
        public void WriteJson(JsonWriter writer, JsonSerializer serializer)
        {
            if (CabinProductElementArray != null)
            {
                serializer.Serialize(writer, CabinProductElementArray);
                return;
            }
            if (PurpleCabinProduct != null)
            {
                serializer.Serialize(writer, PurpleCabinProduct);
                return;
            }
            throw new Exception("Union must not be null");
        }
    ...
    public partial class CabinProduct
    {
        ...
        [JsonProperty("bookingModifier")]
        public string BookingModifier { get; set; }
    ...
    public partial class ServiceFeesGrp
    {
        ...
        [JsonProperty("serviceDetailsGrp")]
        public List<ServiceDetailsGrp> ServiceDetailsGrp { get; set; }
    }
    public partial class ServiceDetailsGrp
    {
        [JsonProperty("serviceOptionInfo")]
        public ServiceOptionInfo ServiceOptionInfo { get; set; }

        [JsonProperty("feeDescriptionGrp")]
        public FeeDescriptionGrp FeeDescriptionGrp { get; set; }
    }
   
    public partial class FeeDescriptionGrp
    {
        [JsonProperty("itemNumberInfo")]
        public FeeDescriptionGrpItemNumberInfo ItemNumberInfo { get; set; }
        [JsonProperty("serviceDescriptionInfo")]
        public ServiceDescriptionInfo ServiceDescriptionInfo { get; set; }

        [JsonProperty("commercialName")]
        public CommercialName CommercialName { get; set; }

    }
    public partial class ServiceDescriptionInfo
    {
        [JsonProperty("serviceRequirementsInfo")]
        public ServiceRequirementsInfo ServiceRequirementsInfo { get; set; }
    }
    public partial class ServiceRequirementsInfo
    {
        [JsonProperty("serviceClassification")]
        public string ServiceClassification { get; set; }

        [JsonProperty("serviceMarketingCarrier")]
        public string ServiceMarketingCarrier { get; set; }

        [JsonProperty("serviceGroup")]
        public string ServiceGroup { get; set; }

        [JsonProperty("serviceSubGroup")]
        public string ServiceSubGroup { get; set; }
    }
    public partial class FeeDescriptionGrpItemNumberInfo
    {
    ...
    {
        [JsonProperty("freeTextQualification")]
        public CommercialNameFreeTextQualification FreeTextQualification { get; set; }

        [JsonProperty("freeText")]
        public string FreeText { get; set; }
    }

    public partial class CommercialNameFreeTextQualification
    {
        [JsonProperty("textSubjectQualifier")]
        public long TextSubjectQualifier { get; set; }
    }
    public partial class ServiceOptionInfo
    {
        [JsonProperty("dataTypeInformation")]
        public DataTypeInformation DataTypeInformation { get; set; }
    }

    public partial class DataTypeInformation
    {
    ...
    internal class Converter : JsonConverter
    {
        ...
        public override object ReadJson(JsonReader reader, Type t, object existingValue, JsonSerializer serializer)
        {
            ...
            if (t == typeof(ServiceFeesGrpUnion) || t == typeof(ServiceFeesGrpUnion?))
                return new ServiceFeesGrpUnion(reader, serializer);
            ...
            if (t == typeof(CabinProductUnion) || t == typeof(CabinProductUnion?))
                return new CabinProductUnion(reader, serializer);
        ...
        public override void WriteJson(JsonWriter writer, object value, JsonSerializer serializer)
        {
            ...
            if (t == typeof(ServiceFeesGrpUnion))
            {
                ((ServiceFeesGrpUnion)value).WriteJson(writer, serializer);
                return;
            }
            ...
            if (t == typeof(CabinProductUnion))
            {
                ((CabinProductUnion)value).WriteJson(writer, serializer);
                return;
            }
            throw new Exception("Unknown type");
        }
