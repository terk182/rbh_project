...
namespace BL.Entities.InformativePricing
{
    ...
    public partial class FareAmount
    {
        ...
        public MonetaryDetailsUnion MonetaryDetails { get; set; }

        [JsonProperty("otherMonetaryDetails")]
        public MonetaryDetailsUnion OtherMonetaryDetails { get; set; }
    }
    public partial struct MonetaryDetailsUnion
    {
        public List<MonetaryDetails> MonetaryDetailsElementArray;
        public MonetaryDetails PurpleMonetaryDetails;

        public bool IsNull => MonetaryDetailsElementArray == null && PurpleMonetaryDetails == null;
    }
    ...
    internal static class Converter
    {
        public static readonly JsonSerializerSettings Settings = new JsonSerializerSettings
        {
            ...
            Converters = {
                ...
                new MonetaryDetailsUnionConverter(),
    ...
    internal class MonetaryDetailsUnionConverter : JsonConverter
    {
        public override bool CanConvert(Type t) => t == typeof(MonetaryDetailsUnion) || t == typeof(MonetaryDetailsUnion?);
        ...
        public override object ReadJson(JsonReader reader, Type t, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                case JsonToken.StartObject:
                    var objectValue = serializer.Deserialize<MonetaryDetails>(reader);
                    return new MonetaryDetailsUnion { PurpleMonetaryDetails = objectValue };
                case JsonToken.StartArray:
                    var arrayValue = serializer.Deserialize<List<MonetaryDetails>>(reader);
                    return new MonetaryDetailsUnion { MonetaryDetailsElementArray = arrayValue };
            }
            throw new Exception("Cannot unmarshal type MonetaryDetailsUnion");
        }

        public override void WriteJson(JsonWriter writer, object untypedValue, JsonSerializer serializer)
        {
            var value = (MonetaryDetailsUnion)untypedValue;
            if (value.MonetaryDetailsElementArray != null)
            {
                serializer.Serialize(writer, value.MonetaryDetailsElementArray); return;
            }
            if (value.PurpleMonetaryDetails != null)
            {
                serializer.Serialize(writer, value.PurpleMonetaryDetails); return;
            }
            throw new Exception("Cannot marshal type MonetaryDetailsUnion");
        }
    }
