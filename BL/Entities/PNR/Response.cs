...
namespace BL.Entities.PNR
{
    ...
    public partial class PnrReply
    {
        ...
        public PnrHeaderUnion PnrHeader { get; set; }
    ...
    public partial class DataElementsIndiv
    {
        ...
        [JsonProperty("ticketElement", NullValueHandling = NullValueHandling.Ignore)]
    ...
    public partial class ItineraryReservationInfo
    {
        ...
        public ItineraryReservationInfoReservation Reservation { get; set; }
    }

    public partial class ItineraryReservationInfoReservation
    {
        [JsonProperty("companyId")]
        public string CompanyId { get; set; }
    ...
    public partial struct PnrHeaderUnion
    {
        public List<PnrHeader> PnrHeaderElementArray;
        public PnrHeader PurplePnrHeader;

        public bool IsNull => PnrHeaderElementArray == null && PurplePnrHeader == null;
    }
    ...
    internal class PnrHeaderUnionConverter : JsonConverter
    {
        public override bool CanConvert(Type t) => t == typeof(PnrHeaderUnion) || t == typeof(PnrHeaderUnion?);
        ...
        public override object ReadJson(JsonReader reader, Type t, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                case JsonToken.StartObject:
                    var objectValue = serializer.Deserialize<PnrHeader>(reader);
                    return new PnrHeaderUnion { PurplePnrHeader = objectValue };
                case JsonToken.StartArray:
                    var arrayValue = serializer.Deserialize<List<PnrHeader>>(reader);
                    return new PnrHeaderUnion { PnrHeaderElementArray = arrayValue };
            }
            throw new Exception("Cannot unmarshal type PnrHeaderUnion");
        }

        public override void WriteJson(JsonWriter writer, object untypedValue, JsonSerializer serializer)
        {
            var value = (PnrHeaderUnion)untypedValue;
            if (value.PnrHeaderElementArray != null)
            {
                serializer.Serialize(writer, value.PnrHeaderElementArray); return;
            }
            if (value.PurplePnrHeader != null)
            {
                serializer.Serialize(writer, value.PurplePnrHeader); return;
            }
            throw new Exception("Cannot marshal type PnrHeaderUnion");
        }
    }
