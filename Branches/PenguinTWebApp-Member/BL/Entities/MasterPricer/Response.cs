...
namespace BL.Entities.MasterPricer
{
    ...
    {
        public override bool CanConvert(Type t) => t == typeof(FlightDetailsUnion) || t == typeof(PaxFareProductUnion) || t == typeof(FareUnion) || t == typeof(PriceType) || t == typeof(TentacledGroupOfFares) || t == typeof(CodeShareDetails) || t == typeof(TravellerUnion) || t == typeof(FareDetails) || t == typeof(FareDetailsGroupOfFares) || t == typeof(SegmentFlightRefUnion) || t == typeof(ReferencingDetailUnion) || t == typeof(FlightIndexUnion) || t == typeof(FareDetailUnion) || t == typeof(PaxReferenceUnion) || t == typeof(ReferencingDetailUnion) || t == typeof(FlightDetailsUnion?) || t == typeof(PaxFareProductUnion?) || t == typeof(FareUnion?) || t == typeof(PriceType?) || t == typeof(TentacledGroupOfFares?) || t == typeof(CodeShareDetails?) || t == typeof(TravellerUnion?) || t == typeof(FareDetails?) || t == typeof(FareDetailsGroupOfFares?) || t == typeof(SegmentFlightRefUnion?) || t == typeof(ReferencingDetailUnion?) || t == typeof(FlightIndexUnion?) || t == typeof(FareDetailUnion?) || t == typeof(FareTypeUnion?) || t == typeof(PaxReferenceUnion?) || t == typeof(ReferencingDetailUnion?);
