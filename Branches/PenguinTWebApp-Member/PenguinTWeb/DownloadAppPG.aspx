...
<%
    ...
    If b.IsMatch(u) Or v.IsMatch(Left(u, 4)) Then
        ...
        If u.Contains("iPad") Or u.Contains("iPhone") Then
            'detectingApp("iOS")

            deepLink = "Gogojii://"
            storeLink = "https://itunes.apple.com/us/app/Gogojii-prahyad-kha-taw-kheruxng/id1101588342?ls=1&mt=8"

        ElseIf u.Contains("Android") Then
            'detectingApp("Android")

            deepLink = "Gogojii://"
            storeLink = "https://play.google.com/store/apps/details?id=com.dev.developer.Gogojii"

            'ElseIf u.Contains("Windows Phone") Then
            '    Response.Write("Windows Phone")
        Else
            Response.Redirect("http://www.fareok.com/main/en/app/download/download-app")
        End If
    Else
        Response.Redirect("http://www.fareok.com/main/en/app/download/download-app")
    End If
...
<head>
    <title></title>
     <script type="text/javascript" language="javascript">
         var link1 = '<%=deepLink %>'; var link2 = '<%=storeLink %>';
         //         window.setTimeout(function () {  window.location = link2; }, 25); window.location = link1;
         var now = new Date().valueOf();
         setTimeout(function () {
             if (new Date().valueOf() - now > 6500) return;
